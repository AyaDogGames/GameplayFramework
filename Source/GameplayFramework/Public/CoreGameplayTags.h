...
namespace CoreGameplayTags
{
	...
	DA_DECLARE_GAMEPLAY_TAG_EXTERN(TAG_Equip_Slot_WeaponMain);
	DA_DECLARE_GAMEPLAY_TAG_EXTERN(TAG_Equip_Slot_WeaponOff);
	DA_DECLARE_GAMEPLAY_TAG_EXTERN(TAG_Equip_Slot_Skill1);
	DA_DECLARE_GAMEPLAY_TAG_EXTERN(TAG_Equip_Slot_Skill2);
	DA_DECLARE_GAMEPLAY_TAG_EXTERN(TAG_Equip_Slot_Item1);
	DA_DECLARE_GAMEPLAY_TAG_EXTERN(TAG_Equip_Slot_Item2);
	DA_DECLARE_GAMEPLAY_TAG_EXTERN(TAG_Equip_Slot_Item3);
	DA_DECLARE_GAMEPLAY_TAG_EXTERN(TAG_Equip_Slot_Item4);
